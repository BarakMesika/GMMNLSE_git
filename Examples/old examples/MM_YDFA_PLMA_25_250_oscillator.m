...
saveDir = 'D:\GMMNLSE\SimData\Oscillator_HighPower_PLMA-YDF-25-250-VIII\PH012um_sat075\';
mkdir(saveDir);
fiber.gain_coeff = 2*log(1000)/fiber.L0*500;
fiber.gain_fwhm = 40e-9;
fiber.saturation_intensity  = 075e-9/(pi*(25e-6/2)^2);
...
%%
    ...
    for RT=1:100
        ...
        %Pinhole
        input_field.fields = get_modes_pinhole(Mfield, input_field.fields, dx, 3e-6, [0e-6 0e-6]);
