...
fiber.MM_folder = '../Fibers/GIF50_55_modes_LR/';
fiber.betas_filename = 'betas.mat';
fiber.S_tensors_filename = 'S_tensors_55modes.mat';
...
gain_rate_eqn.core_diameter = 50; % um
...
gain_rate_eqn.midx = 1:55; % the mode index
gain_rate_eqn.mode_volume = 55; % the total number of available spatial modes in the fiber
...
fiber.L0 = 0.25; % m; the length of the gain fiber
save_num = 50;
...
for iiE=1:3
    ...
    dirName  = ['GIF50_BC\SeedModeNum_' num2str(M_num) '\Fundamental_' num2str(E_LP01*100) '_Etotal_' num2str(E_all) '\'];
    mkdir(dirName);
    data.t = t;
    data.lambda = lambda;
