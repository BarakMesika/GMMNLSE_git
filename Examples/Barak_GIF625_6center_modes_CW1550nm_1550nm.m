function [fiber, sim, input_field, others] = Barak_GIF625_6center_modes_CW1550nm_1550nm()
        %% Other Prameters
        others.data_folder = 'BarakTest_Beam_Cleanup\'; % where to save the propagation data
        
        %% Fiber parameters
        fiber.MM_folder = '../Fibers/Barak_GIF625_6modes_CW1550nm_1550nm/';               % Fiber data folder
        fiber.L0 = 2;                                                                 % Fiber length [m]
        fiber.n2 = 3.2e-20;                                                              % non linear coeff [m^2/W]
        % fiber.gain_Aeff = ;                                                           % deffault is 1.6178e-10
        
        %% Simulation parameters
        time_window = 15;                                                          % Time Window [ps]
        N = 2^18;                                                                  % the number of time points8
        save_num = 200;                                                                % how many popagation points to save
        ...
        E_modes = ones(1,others.modes);
		E_modes = E_modes * 1/ others.modes;
