function [fiber, sim, input_field, others] = DC_KBSC_10modes_1030nm(E_tot)


        %% Other Prameters
        others.data_folder = 'GIF625_KBSC_DC_10modes_1030nm_energy_sweep\'; % where to save the propagation data
