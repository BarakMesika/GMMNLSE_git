function [fiber, sim, input_field, others] = GIF625_520nm_NanoSecPulse(L0,N,dz,E_tot)
        ...
        %% Other Prameters
        others.data_folder = 'GIF625_debug\'; % where to save the propagation data
        ...
        % input_field.E_tot = 2.3e9;   % 2e4 ->2e9                                  % Total Energy [pJ]
        input_field.E_tot = E_tot;
        E_modes(1) = 0.2; E_modes(2) = 0.2; E_modes(3) = 0.2; E_modes(4) = 0.2; E_modes(5) = 0.2;
