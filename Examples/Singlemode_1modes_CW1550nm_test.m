...
function [fiber, sim, input_field, others] = Singlemode_1modes_CW1550nm_test()
        %% Fiber parameters
        ...
        sim.deltaZ = 200e-6;                                                            % delta z point [m] 
        ...
        % 
        % 
        % input_field.E_tot = 3*P0;                                      % Total Energy [pJ]
