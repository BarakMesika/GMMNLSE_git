__global__ void calculate_sumterm_part(float2* Kerr, const float2* A_t, const float* SRa, const unsigned char* nonzero_midx1234s, const unsigned int N, const unsigned int M, const float SK_factor, const unsigned int NUM_NONZERO, const unsigned int NUM_MODES) {
