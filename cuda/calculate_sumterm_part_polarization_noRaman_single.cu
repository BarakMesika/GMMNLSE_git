__global__ void calculate_sumterm_part(float2* Kerr, const float2* A_t, const float* SK, const unsigned char* SK_nonzero_midx1234s, const unsigned int N, const unsigned int M, const unsigned int NUM_SK_NONZERO, const unsigned int NUM_MODES) {
