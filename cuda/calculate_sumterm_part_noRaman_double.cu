__global__ void calculate_sumterm_part(double2* Kerr, const double2* A_t, const double* SRa, const unsigned char* nonzero_midx1234s, const unsigned int N, const unsigned int M, const double SK_factor, const unsigned int NUM_NONZERO, const unsigned int NUM_MODES) {
