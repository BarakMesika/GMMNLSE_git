...
for n_it = 1:sim.n_tot_max
    ...
    for ii = 2:sim.MPA.M+1
        ...
        if gain_rate_eqn.export_N2
            [Power_pump_forward_ii,Power_ASE_forward_ii,G,N2] = solve_gain_rate_eqn('forward',sim,gain_rate_eqn,A_w_ii,A0_backward,last_Power_pump_forward,Power_pump_backward,last_Power_ASE_forward,Power_ASE_backward,omegas,dt,sim.deltaZ,cross_sections_pump,cross_sections,overlap_factor,N_total,FmFnN,GammaN,first_backward_before_iterations );
        else
            [Power_pump_forward_ii,Power_ASE_forward_ii,G]    = solve_gain_rate_eqn('forward',sim,gain_rate_eqn,A_w_ii,A0_backward,last_Power_pump_forward,Power_pump_backward,last_Power_ASE_forward,Power_ASE_backward,omegas,dt,sim.deltaZ,cross_sections_pump,cross_sections,overlap_factor,N_total,FmFnN,GammaN,first_backward_before_iterations );
        end
...
if gain_rate_eqn.export_N2
    varargout = {num_it_tot, A1_right_end, Power_pump_forward_ii, Power_ASE_forward_ii, N2};
else
    varargout = {num_it_tot, A1_right_end, Power_pump_forward_ii, Power_ASE_forward_ii};
end
