...
if ~isempty(lambda_outside_lambda_raw_left)
    ...
    absorption(1:length(lambda_outside_lambda_raw_left)) = exponential_decay(lambda_raw(1),absorption_raw(1),absorption_raw_slope_left,lambda_outside_lambda_raw_left);
    emission  (1:length(lambda_outside_lambda_raw_left)) = exponential_decay(lambda_raw(1),  emission_raw(1),  emission_raw_slope_left,lambda_outside_lambda_raw_left);
end
% The right part
if ~isempty(lambda_outside_lambda_raw_right)
    ...
    % Compute extrapolations
    absorption(end-length(lambda_outside_lambda_raw_right)+1:end) = exponential_decay(lambda_raw(end),absorption_raw(end),absorption_raw_slope_right,lambda_outside_lambda_raw_right);
    emission  (end-length(lambda_outside_lambda_raw_right)+1:end) = exponential_decay(lambda_raw(end),  emission_raw(end),  emission_raw_slope_right,lambda_outside_lambda_raw_right);
end
