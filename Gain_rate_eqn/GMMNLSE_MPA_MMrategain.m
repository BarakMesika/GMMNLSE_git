...
for n_it = 1:sim.MPA.n_tot_max
    ...
    if gain_rate_eqn.export_N2
        [Power_pump_forward,Power_ASE_forward,gain_term,N2] = solve_gain_rate_eqn('forward',sim,gain_rate_eqn,A_w,A0_backward,Power_pump_forward,Power_pump_backward,Power_ASE_forward,Power_ASE_backward,omegas,dt,sim.deltaZ,cross_sections_pump,cross_sections,overlap_factor,N_total,FmFnN,GammaN,first_backward_before_iterations );
    else
        [Power_pump_forward,Power_ASE_forward,gain_term]    = solve_gain_rate_eqn('forward',sim,gain_rate_eqn,A_w,A0_backward,Power_pump_forward,Power_pump_backward,Power_ASE_forward,Power_ASE_backward,omegas,dt,sim.deltaZ,cross_sections_pump,cross_sections,overlap_factor,N_total,FmFnN,GammaN,first_backward_before_iterations );
    end
...
if gain_rate_eqn.export_N2
    varargout = {num_it_tot, A1_right_end, Power_pump_forward(:,:,:,:,:,end), Power_ASE_forward(:,:,:,:,:,end), N2(:,:,:,:,:,:,end)};
else
    varargout = {num_it_tot, A1_right_end, Power_pump_forward(:,:,:,:,:,end), Power_ASE_forward(:,:,:,:,:,end)};
end
