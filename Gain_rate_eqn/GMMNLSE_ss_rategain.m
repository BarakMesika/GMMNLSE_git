...
if gain_rate_eqn.export_N2
    [Power_pump_forward,Power_ASE_forward,G,N2] = solve_gain_rate_eqn('forward',sim,gain_rate_eqn,A0,A0_backward,Power_pump_forward,Power_pump_backward,Power_ASE_forward,Power_ASE_backward,omegas,dt,sim.deltaZ,cross_sections_pump,cross_sections,overlap_factor,N_total,FmFnN,GammaN,first_backward_before_iterations );
else
    [Power_pump_forward,Power_ASE_forward,G]    = solve_gain_rate_eqn('forward',sim,gain_rate_eqn,A0,A0_backward,Power_pump_forward,Power_pump_backward,Power_ASE_forward,Power_ASE_backward,omegas,dt,sim.deltaZ,cross_sections_pump,cross_sections,overlap_factor,N_total,FmFnN,GammaN,first_backward_before_iterations );
end
