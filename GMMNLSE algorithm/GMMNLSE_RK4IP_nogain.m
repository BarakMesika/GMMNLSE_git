function A1 = GMMNLSE_RK4IP_nogain(A0, dt, sim, prefactor, SRa_info, SRb_info, SK_info, D, haw, hbw)
%GMMNLSE_RK4IP_NOGAIN Take one step according to the GMMNLSE, using the Runge-kutta 4 under the interaction picture without gain
...
a1 = expD.*N_op(       A0,        dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, N, num_modes)*sim.deltaZ;
...
a4 =       N_op(expD.*(A_IP+a3),  dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, N, num_modes)*sim.deltaZ;
