function [A1,a5,...
          opt_deltaZ,success] = GMMNLSE_RK4IP_nogain_adaptive(A0, dt, sim, prefactor, SRa_info, SRb_info, SK_info, D_op, haw, hbw, a5_1)
%GMMNLSE_RK4IP_NOGAIN_ADAPTIVE Take one step according to the GMMNLSE, using the Runge-kutta 4 under the interaction picture without gain
...
a4 =       N_op(expD.*(A_IP+a3*(sim.deltaZ)),  dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, N, num_modes);
