function A1 = GMMNLSE_ss_SMgain(A0, dt, sim, prefactor, SRa_info, SRb_info, SK_info, D, haw, hbw, G, saturation_energy)
%GMMNLSE_SS_SMGAIN Take one step according to the GMMNLSE, with a total energy saturating gain model
...
DG = exp(D + G/(1+total_energy/saturation_energy));
A_t = fft(DG.*A0);
