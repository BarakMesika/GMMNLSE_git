function A1 = GMMNLSE_RK4IP_taylorgain(A0, dt, sim, prefactor, SRa_info, SRb_info, SK_info, D, haw, hbw, G, saturation_intensity, fr)
%GMMNLSE_RK4IP_TAYLORGAIN Take one step according to the GMMNLSE, with a spatially saturating gain model based on a Taylor expansion
...
a1 = expD.*N_op(       A0,        dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
a2 =       N_op(       A_IP+a1/2, dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
a3 =       N_op(       A_IP+a2/2, dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
a4 =       N_op(expD.*(A_IP+a3),  dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
