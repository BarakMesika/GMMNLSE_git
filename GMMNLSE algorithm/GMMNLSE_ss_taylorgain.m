function A1 = GMMNLSE_ss_taylorgain(A0, dt, sim, prefactor, SRa_info, SRb_info, SK_info, D, haw, hbw, G, saturation_intensity, fr)
%GMMNLSE_SS_STEP_TAYLORGAIN Take one step according to the GMMNLSE, with a spatially saturating gain model based on a Taylor expansion
...
% 2) Propagate through the nonlinearity + gain with RK4
k1 = N_op(A_t,      dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
k2 = N_op(A_t+k1/2, dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
k3 = N_op(A_t+k2/2, dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
k4 = N_op(A_t+k3,   dt, sim, SK_info, SRa_info, SRb_info, Kerr, Ra, Rb, haw, hbw, anisotropic_Raman_included, prefactor, polar, saturation_intensity, transfer_matrix, fr, recovery_idx, G, dA_dz_gain, N, num_modes, num_spatial_modes)*sim.deltaZ;
...
dAdz = fft(prefactor.*ifft(nonlinear) + dA_dz_gain);
