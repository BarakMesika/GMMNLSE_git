...
function data = Barak_GIF625_3modes_CW1550nm_1550nm()
data.folder_name = 'Barak_GIF625_3modes_CW1550nm_1550nm';    % folder where the output will be stored
...
data.num_modes = 3;                              % number of modes to calculate
