...
lrange = 200e-9;                             % [m] wavelength range. Should be the same as the range used to calculate the modes
modes_list=1:28;                             % usually just 1:num_modes, but it can be different
                
polynomial_fit_order = 8;                    % polyfit order
num_disp_orders = 4;                         % i.e. if this is 3, 4 coefficients will be calculated, including the 0th order
                
radius = 31;                                 % Only needed for the file name
folder_name = 'GIF625_28modes_CW1030nm';     % fiber folder name
