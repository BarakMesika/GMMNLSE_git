...
function data = Barak_KBSC_15modes_1030nm()
data.folder_name = 'Barak_KBSC_15modes_1030nm';    % folder where the output will be stored

% wavelength and modes
data.lambda0 = 1030e-9;                          % center wavelength [m]
...
data.num_modes = 15;                              % number of modes to calculate
